...
//The MAIN function, from here we start the application and run the loop
int main()
{
    //Init GLFW
    glfwInit();
    ...
    GLFWwindow* window = glfwCreateWindow(800, 600, "OpenGLTriangle", nullptr, nullptr);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glBindVertexArray(VAO);
        glDrawArrays(GL_TRIANGLES, 0, 3); //We set the count to 3 since we're drawing 3 vertices.
        glBindVertexArray(0);
